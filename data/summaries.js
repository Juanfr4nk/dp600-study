const SUMMARIES = [
  {
    ...
    keyPoints: [
      "OneLake: un almacenamiento unificado por tenant",
      "Componentes: Lakehouse, Warehouse, Eventhouse, Notebooks, Pipelines, Dataflows, Semantic Models",
      "SaaS: sin infraestructura que gestionar",
      "Licenciamiento por Capacity (F2-F2048)"
    ],
  ...
  },
  {
    id: 2,
    domain: 1,
    title: "Lakehouses en Microsoft Fabric",
    ...
    keyPoints: [
      "Formato nativo: Delta Lake (Parquet + transaction log)",
      "Secciones: Tables (Delta) y Files (cualquier formato)",
      "SQL Analytics Endpoint automático (solo lectura)",
      "Shortcuts para acceder datos externos sin copiarlos",
      "Soporta Spark (PySpark, SQL, Scala, R)"
    ],
  ...
  },
  {
    id: 3,
    domain: 1,
    title: "Data Warehouse en Microsoft Fabric",
    ...
    keyPoints: [
      "T-SQL completo: DDL + DML (Create, Insert, Update, Delete, Merge)",
      "Vistas, funciones y stored procedures",
      "Column-Level Security (GRANT/DENY en columnas)",
      "COPY INTO para cargas masivas de alto rendimiento",
      "Cross-database queries entre Warehouses y Lakehouses"
    ],
  ...
  },
  {
    id: 4,
    domain: 1,
    title: "Pipelines y Data Factory en Fabric",
    ...
    keyPoints: [
      "Pipelines: orquestación con actividades (Copy, Notebook, Dataflow, Script)",
      "Dataflows Gen2: transformación visual con Power Query Online",
      "Programación: triggers por horario o evento",
      "Reintentos y manejo de errores configurable",
      "Parámetros y expresiones dinámicas"
    ],
  ...
  },
  {
    id: 5,
    domain: 1,
    title: "Real-Time Intelligence: Eventhouse y KQL",
    ...
    keyPoints: [
      "Eventhouse: almacén optimizado para streaming y logs",
      "KQL: sintaxis pipe (|), operadores: where, summarize, extend, project, render",
      "Eventstream: captura y enruta datos de streaming visualmente",
      "KQL Queryset: artefacto para escribir y guardar consultas KQL",
      "Nuevo en DP-600 2026 (antes no incluido)"
    ],
  ...
  },
  {
    id: 6,
    domain: 1,
    title: "Delta Lake y Optimización de Datos",
    ...
    keyPoints: [
      "ACID transactions: escrituras atómicas y consistentes",
      "Time Travel: VERSION AS OF / TIMESTAMP AS OF",
      "Schema Evolution: mergeSchema / overwriteSchema",
      "OPTIMIZE + VACUUM para mantenimiento",
      "V-Order (auto) + Z-Order (manual por columna)"
    ],
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "RLS: filtros DAX con USERPRINCIPALNAME() para seguridad dinámica",
      "CLS: GRANT/DENY column-level en T-SQL (solo Data Warehouse)",
      "OLS: oculta tablas/columnas enteras en modelos semánticos",
      "Sensitivity Labels: clasificación (Purview) + protección automática"
    ],
  ...
  },
  {
    id: 8,
    domain: 2,
    title: "Deployment Pipelines y ALM",
    ...
    keyPoints: [
      "3 etapas: Development → Test → Production",
      "Cada etapa = un workspace diferente",
      "Comparación visual de cambios entre etapas",
      "Rules: permiten cambiar conexiones/parámetros por etapa",
      "Git Integration: Azure DevOps o GitHub para versionado"
    ],
    link: "https://learn.microsoft.com/es-es/training/modules/administer-fabric/"
  },
  {
    ...
    keyPoints: [
      "Admin Portal: tenant settings, capacidades, dominios",
      "Monitoring Hub: actividades en tiempo real",
      "Capacity Metrics App: análisis de consumo",
      "Endorsement: Promoted (autor) / Certified (admin)",
      "Lineage View: trazabilidad de datos extremo a extremo"
    ],
    link: "https://learn.microsoft.com/es-es/training/modules/administer-fabric/"
  },
  {
    id: 10,
    domain: 3,
    title: "Modelos Semánticos y Modos de Almacenamiento",
    ...
    keyPoints: [
      "Import: datos en memoria, rápido, requiere refresco",
      "DirectQuery: tiempo real, rendimiento depende del origen",
      "Direct Lake: lee Delta/Parquet de OneLake sin importar",
      "Composite Model: mezcla modos en el mismo modelo",
      "VertiPaq: motor columnar in-memory con compresión"
    ],
  ...
  },
  {
    ...
    keyPoints: [
      "CALCULATE: evalúa expresión en contexto de filtro modificado",
      "Contexto de fila vs contexto de filtro",
      "Medidas > columnas calculadas (rendimiento y flexibilidad)",
      "DIVIDE(a, b) en lugar de a/b (evita error por 0)",
      "REMOVEFILTERS/ALL para ignorar filtros existentes"
    ],
    link: "https://learn.microsoft.com/es-es/training/paths/get-started-fabric/"
  },
  {
    id: 12,
    domain: 3,
    title: "Time Intelligence en DAX",
    ...
    keyPoints: [
      "Requisito: tabla de fechas marcada como Date Table, sin gaps",
      "TOTALYTD(medida, fechas): acumulado del año",
      "SAMEPERIODLASTYEAR(fechas): mismo periodo año anterior",
      "DATEADD(fechas, -N, unidad): desplazamiento flexible",
      "Calculation Groups: YTD/MTD/PY como items reutilizables"
    ],
    link: "https://learn.microsoft.com/es-es/training/paths/get-started-fabric/"
  },
  {
    id: 13,
    domain: 3,
    title: "Modelado de Datos: Star Schema y Relaciones",
    ...
    keyPoints: [
      "Star Schema: hechos (centro) + dimensiones (puntas)",
      "Relaciones 1:N unidireccionales: dimensión → hechos",
      "Evitar M:N (usar bridge tables si necesario)",
      "Desnormalizar dimensiones (menos joins = mejor rendimiento)",
      "Jerarquías: niveles de drill (País→Región→Ciudad)"
    ],
    link: "https://learn.microsoft.com/es-es/training/paths/get-started-fabric/"
  },
  {
    id: 14,
    domain: 3,
    title: "Direct Lake y Optimización de Rendimiento",
    ...
    keyPoints: [
      "Framing: snapshot de archivos Delta para caché en memoria",
      "Fallback a DirectQuery si excede límites",
      "Optimizar: reducir cardinalidad, V-Order, OPTIMIZE",
      "DAX Studio: Server Timings (FE vs SE)",
  ...
  },
  {
    id: 15,
    domain: 1,
    title: "Notebooks y Spark en Fabric",
  ...
  },
  {
    id: 16,
    domain: 1,
    title: "Power Query M y Dataflows Gen2 en profundidad",
  ...
  },
  {
    id: 17,
    domain: 1,
    title: "Real-Time Intelligence completo",
  ...
  },
  {
    id: 19,
    domain: 3,
    title: "Composite Models y encadenado de modelos",
  ...
  },
  {
    id: 20,
    domain: 3,
    title: "DAX avanzado: Calculation Groups, TREATAS y Variables",
  ...
  },
  {
    id: 22,
    domain: 3,
    title: "XMLA Endpoint y Tabular Model",
  ...
  },
  {
    id: 23,
    domain: 2,
    title: "Microsoft Purview y Fabric Governance",
  ...
  },
  {
    id: 24,
    domain: 2,
    title: "Capacity Management y Licenciamiento",
  ...
  },
  {
    id: 25,
    domain: 2,
    title: "CI/CD y Git Integration en detalle",
  ...
  },
  {
    id: 26,
    domain: 2,
    title: "Networking y Seguridad avanzada",
  ...
  },
  {
    id: 28,
    domain: 2,
    title: "Data Domains y Data Mesh en Fabric",
  ...
  },
  {
    id: 29,
    domain: 3,
    title: "Hybrid Tables e Incremental Refresh avanzado",
  ...
  },
  {
    id: 30,
    domain: 1,
    title: "OneLake, Mirroring y Cross-database Queries",
  ...
  },
  {
    id: 31,
    domain: 3,
    title: "DAX Windowing: OFFSET()",
    summary: "La función **OFFSET()** permite recuperar una fila relativa (anterior/siguiente) dentro de un conjunto ordenado en DAX. Se usa con **ORDERBY()** y, opcionalmente, **PARTITIONBY()** para evitar mezclar grupos. Es especialmente útil para comparativas fila actual vs fila previa, un patrón similar a LAG/LEAD de SQL. A diferencia de DATEADD, no depende exclusivamente de una tabla de fechas; opera sobre orden de filas definido en la expresión. En escenarios DP-600, OFFSET aparece en preguntas de variación secuencial y análisis de tendencias por entidad.",
    keyPoints: [
      "OFFSET devuelve filas relativas en un orden definido",
      "ORDERBY es clave para secuencia estable",
      "PARTITIONBY segmenta por grupo (ej. región)",
      "Útil para comparación actual vs anterior",
      "No reemplaza todas las funciones de time-intelligence"
    ],
    link: "https://learn.microsoft.com/es-es/dax/offset-function-dax"
  },
  {
    id: 32,
    domain: 3,
    title: "DAX Windowing: INDEX()",
    summary: "**INDEX()** devuelve una fila por posición dentro de un conjunto ordenado. Es útil para obtener primera, última o N-esima fila por partición, sin recurrir a patrones más verbosos con TOPN. En combinación con ORDERBY/PARTITIONBY, INDEX ayuda a construir cálculos deterministas en ranking y selección posicional. Un error común es pensar que INDEX crea índices físicos; en realidad define navegación lógica de filas dentro del cálculo. En examen, suele aparecer en escenarios de \"fila exacta\" o desempates controlados.",
    keyPoints: [
      "INDEX selecciona posición exacta dentro de una ventana",
      "No crea índices físicos en almacenamiento",
      "Complementa ranking y selección de extremos",
      "Puede combinarse con particiones por dimensión",
      "Evita ambigüedad al usar desempate en ORDERBY"
    ],
    link: "https://learn.microsoft.com/es-es/dax/index-function-dax"
  },
  {
    id: 33,
    domain: 3,
    title: "DAX Windowing: WINDOW()",
    summary: "**WINDOW()** define un rango de filas relativo para cálculos como running total o moving average. Se suele combinar con iteradores (SUMX, AVERAGEX) para evaluar medidas sobre ese subconjunto. Aporta flexibilidad cuando la ventana no está estrictamente ligada a periodos de calendario estándar. Frente a DATESINPERIOD, WINDOW da control posicional más fino y puede resolver escenarios de orden arbitrario. Su uso efectivo requiere buen diseño de ORDERBY y particiones para evitar resultados inconsistentes.",
    keyPoints: [
      "WINDOW define ventanas deslizantes por filas",
      "Funciona bien con SUMX/AVERAGEX",
      "No depende de calendario continuo",
      "Requiere ORDERBY explícito",
      "Ideal para running totals y moving averages avanzados"
    ],
    link: "https://learn.microsoft.com/es-es/dax/window-function-dax"
  },
  {
    id: 34,
    domain: 1,
    title: "OneLake Catalog para Data Discovery",
    summary: "**OneLake Catalog** centraliza el descubrimiento de activos de datos en Fabric (lakehouses, warehouses, modelos y más). Permite filtrar por dominio, tipo de activo y señales de confianza como Promoted/Certified. Esto facilita autoservicio gobernado y reduce duplicación de datasets. A diferencia del browser de un workspace, el catálogo aporta visibilidad transversal según permisos. En DP-600, se asocia a casos donde un analista necesita encontrar contenido confiable rápidamente.",
    keyPoints: [
      "Búsqueda transversal de activos en Fabric",
      "Filtros por tipo, dominio y endorsement",
      "Respeta permisos y políticas de gobernanza",
      "Acelera reutilización de datasets confiables",
      "Diferente al browser local de workspace"
    ],
    link: "https://learn.microsoft.com/es-es/fabric/onelake/onelake-data-hub"
  },
  {
    id: 35,
    domain: 1,
    title: "Real-Time Hub para descubrir streams",
    summary: "**Real-Time Hub** está orientado al descubrimiento y consumo de streams/eventos en Fabric. Ayuda a identificar fuentes de datos en tiempo real y conectarlas con Eventstream u otros componentes de Real-Time Intelligence. No debe confundirse con Monitoring Hub, que muestra estado de ejecuciones operativas. Su valor principal es reducir fricción para equipos que trabajan con telemetría y eventos. En examen, suele aparecer en escenarios IoT o alertas near real-time.",
    keyPoints: [
      "Descubre activos y streams en tiempo real",
      "Se integra con Eventstream y RTI",
      "No reemplaza Monitoring Hub",
      "Acelera casos de IoT y eventos",
      "Complementa gobierno y observabilidad"
    ],
    link: "https://learn.microsoft.com/es-es/fabric/real-time-intelligence/real-time-hub"
  },
  {
    id: 36,
    domain: 3,
    title: "Direct Lake on OneLake vs SQL endpoint",
    summary: "Fabric permite elegir entre **Direct Lake on OneLake** y **Direct Lake on SQL endpoint** según el escenario. OneLake prioriza acceso directo a tablas Delta con baja latencia y arquitectura simple. SQL endpoint es útil cuando necesitas reutilizar vistas SQL, lógica relacional existente o contratos de datos establecidos en esa capa. La decisión debe balancear rendimiento, gobernanza y mantenibilidad en ALM. En DP-600, este skill suele evaluarse con preguntas de arquitectura y trade-offs.",
    keyPoints: [
      "OneLake: acceso directo a Delta",
      "SQL endpoint: reutilización de lógica/vistas SQL",
      "Evaluar latencia vs flexibilidad",
      "Validar seguridad y dependencias al cambiar ruta",
      "Alinear elección con estándares de la organización"
    ],
    link: "https://learn.microsoft.com/es-es/fabric/fundamentals/direct-lake-overview"
  },
  {
    id: 37,
    domain: 3,
    title: "Large Semantic Model Storage Format",
    summary: "**Large Semantic Model Storage Format** permite operar modelos semánticos de gran tamaño en capacidades Premium/Fabric. Es relevante cuando hay alta cardinalidad, muchas particiones y necesidades de administración avanzada. Se complementa con XMLA endpoint para automatización y con incremental refresh para eficiencia operacional. No es una función aislada: forma parte de una estrategia de escalabilidad tabular empresarial. En examen, aparece junto a preguntas de capacidad, particionado y lifecycle de modelos.",
    keyPoints: [
      "Habilita modelos tabulares de gran escala",
      "Requiere capacidad compatible",
      "Complementa XMLA e incremental refresh",
      "Exige revisar operación y tooling ALM",
      "No sustituye buenas prácticas de modelado"
    ],
    link: "https://learn.microsoft.com/es-es/power-bi/enterprise/service-premium-large-models"
  },
  {
    id: 38,
    domain: 2,
    title: "Development Lifecycle: .pbip, .pbit y .pbids",
    summary: "En el ciclo de desarrollo analítico, **.pbip** mejora colaboración con Git al descomponer artefactos en archivos legibles. **.pbit** permite distribuir plantillas reutilizables sin datos cargados, útil para estandarizar soluciones. **.pbids** simplifica conexión a fuentes en Desktop para onboarding controlado. Combinados con shared semantic models, reducen duplicación y aumentan consistencia. Este conjunto de habilidades forma parte explícita del dominio de lifecycle en DP-600.",
    keyPoints: [
      ".pbip favorece diffs/merge/review",
      ".pbit distribuye estructura sin datos",
      ".pbids simplifica conexiones controladas",
      "Shared semantic model centraliza lógica",
      "Claves para ALM moderno en Fabric"
    ],
    link: "https://learn.microsoft.com/es-es/power-bi/developer/projects/projects-overview"
  },
  {
    id: 39,
    domain: 2,
    title: "Impact Analysis y dependencias downstream",
    summary: "Antes de cambiar un activo crítico en Fabric, **Impact Analysis** y **Lineage** permiten identificar consumidores downstream y riesgo potencial. Esta práctica reduce incidentes en producción y mejora comunicación con equipos afectados. Debe integrarse con procesos de PR, pruebas y promoción por pipeline. En entornos multi-dominio, evita romper modelos o reportes que dependen de tablas compartidas. DP-600 evalúa esta capacidad como parte de mantenimiento y gobernanza del lifecycle.",
    keyPoints: [
      "Visualiza dependencias de extremo a extremo",
      "Anticipa qué se rompe antes de cambiar",
      "Complementa Git y Deployment Pipelines",
      "Reduce regresiones en producción",
      "Clave en entornos con activos compartidos"
    ],
    link: "https://learn.microsoft.com/es-es/fabric/governance/impact-analysis"
  },
  {
    id: 40,
    domain: 2,
    title: "Visual Query Editor y File-Level Access Control",
    summary: "**Visual Query Editor** habilita consultas SQL guiadas para usuarios de negocio sin depender de escritura manual avanzada. Es ideal para filtros, joins y agregaciones estándar, mientras que SQL manual sigue siendo mejor para lógica compleja. Por otro lado, **File-Level Access Control** protege carpetas/archivos en Lakehouse, complementando controles semánticos como RLS/CLS/OLS. Juntos cubren productividad y seguridad desde capas diferentes. En DP-600 aparecen como skills explícitos de preparación y mantenimiento.",
    keyPoints: [
      "VQE acelera autoservicio SQL básico",
      "SQL manual para escenarios avanzados",
      "File-level protege almacenamiento en Files",
      "RLS/CLS/OLS protegen consumo semántico",
      "Seguridad robusta requiere enfoque multicapa"
    ],
    link: "https://learn.microsoft.com/es-es/fabric/data-warehouse/visual-query-editor"
  }
];
